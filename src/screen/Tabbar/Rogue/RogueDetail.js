...
export default class RogueDetail extends Component {
    ...
    render() {
        ...
        console.log('00000000000', file_path)
        return (
            <View style={{ flex: 1, paddingTop: hp(13.3) }}>
                <ImageBackground source={bg_icon} style={styles.backgroundImageView}>
                    <Loader loading={loading} />
                    {(file_type === "docx" || file_type === "txt" || file_type === "xlsx" || file_type === "pdf" || file_type === 'xls') &&
                    ...
                    {(file_type === "jpg" || file_type === "png" || file_type === "text" || file_type === "jpeg"  || file_type === 'gif') &&
                        <Content style={{ flex: 1 }} contentContainerStyle={{ alignItems: 'center' }} bounces={false}>
                            <View style={styles.listContainer}>
                                ...
                                <View style={{ padding: 10 }}>
                                    {(file_type === "jpg" || file_type === "png"  || file_type === 'gif') &&
