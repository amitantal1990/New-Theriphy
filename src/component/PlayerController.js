...
export default class PlayerController extends Component {
    ...
    playAudioFile = () => {
        ...
        if (isInitialize) {
            ...
            whoosh = new Sound(encodeURI(this.props.audioUri), null, (error) => {
                if (error) {
                ...
                this.setState({ isPlay: true, isInitialize: false, audioDuration: whoosh.getDuration(), totalTimer: latestValue })
    ...
    render() {
        const { sliderValue, audioDuration, updateTimer, totalTimer, isPlay } = this.state
